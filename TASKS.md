...
- [ ] Review 신규 기사 날짜 정책 재검토
  ...
  - 2026-05-07 review 기준 수집일 대비 2일 이상 오래된 항목 14개 확인.
    - Bloomberg - Patent: 4개. 검색 페이지가 IP 관련성이 낮거나 며칠 지난 기사까지 섞어 노출하는 경향이 있어 우선 점검 대상.
    - IPRdaily: 3개. 홈페이지/목록에 5/3~5/5 글이 남아 있다가 신규 URL로 유입.
    - WTO RSS: 2개. RSS가 5/4~5/5 글을 오늘 처음 신규 URL로 제공한 형태.
    - Asia IP Law: 4개. 5/5 INTA 기사들이 신규 URL로 유입.
    - 중국 상무부 주요뉴스: 1개. 5/5 글이 목록에 남아 있고 seen에 없어 유입.
  - 단기 검토안: review에서는 2일 이상 지난 신규 기사를 별도 "확인 필요/오래된 신규 URL" 섹션으로 분리하거나 소스별 `stale_article_days`/`review_cutoff_days`를 둔다.
